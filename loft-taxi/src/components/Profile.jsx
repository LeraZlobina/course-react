...
import { cardDetails, setProfileSubmit } from "../modules/profile/actions";
...
const Profile = () => {
    ...
    const sendCardDetails = (event) => {
        ...
        const { cardNumber, expiryDate, cardName, cvc/*, token*/ } = event.target;
        dispatch(cardDetails(cardNumber.value, expiryDate.value, cardName.value, cvc.value/*, token.value*/));
    }

    useEffect(() => {
        dispatch(setProfileSubmit());
    },[]);
    ...
    return (
        <div className="wrapper">
            ...
            <section className="profile-section">
                <div className="profile-section__wrapper">
                    <div className="profile-wrapper"></div>
                    <form data-testid="profile" className="profile" onSubmit={sendCardDetails}>
                        <h1 className="profile__title">Профиль</h1>
